...
import { Heart, MessageCircle, Share2, Download, RefreshCw, Music, Check, UserPlus, Flag } from 'lucide-react';
...
export const VideoCard: React.FC<VideoCardProps> = ({
  ...
  return (
    <div
      ...
      className="relative w-full h-full snap-start flex items-center justify-center overflow-hidden bg-black select-none"
    >
      <video
        src={videoSourceUrl}
      ...
      <div className="absolute right-3 bottom-20 z-20 flex flex-col items-center gap-4">
        ...
        {/* DOWNLOAD / SAVE BUTTON (Save directly to phone's Gallery like TikTok) */}
        <button
